...
- Corriger le problème de navabar dans PageHistoire.html 
- Trouver deux autres versions de Debian a raconter
- Faire la page de biographie du créateur de Debian Ian Murdock

Total de page html (6-7 pages)
